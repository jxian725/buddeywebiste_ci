        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{ route('role.create') }}" style="float:right;" data-toggle="tooltip" title="Add" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Add New">
    ...
    var table = $('#role_table').DataTable({
        ...
        drawCallback: function( settings ) {
          ...
          $('.deleterole').on('click',function(){
              var x = confirm("Do you want to delete the role?");
              if(x == true) { 
