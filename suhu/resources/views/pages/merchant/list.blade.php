        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">{{ __('Manage Merchants') }}</h3>
                  <a href="{{ route('merchant.create') }}" style="float:right;" data-toggle="tooltip" title="Add" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Add New">
                    <i class="fa fa-plus"></i> {{ __('Add New Merchant') }}
                </a>
                </div>
                <!-- /.card-header -->
              <div class="card-body"> 
                @if ($message = Session::get('success'))
                    ...
                    @endif                  
                    <table class="table table-bordered table-striped" id="merchant_table">
                        <thead>
                            <tr>
                                <th>{{ __('Name') }}</th>                               
                                <th>{{ __('Email') }}</th>                                
