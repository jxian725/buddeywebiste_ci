...
class Pendingtripmodel extends CI_Model {

	public $primaryKey 		= 'service_id';
    public $column_order 	= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_providing_region','rate_per_person','service_id','service_id','service_id','service_list.status'); 
    public $column_search 	= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_providing_region','rate_per_person','service_id','service_id','service_id','service_list.status');
    public $allcolumn_search= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_providing_region','rate_per_person','service_id','service_id','service_id','service_list.status');
    ...
    public function count_all($where=false){
    	$this->db->select('
                    service_list.*,
                    guider.first_name AS guiderName,rate_per_person,
