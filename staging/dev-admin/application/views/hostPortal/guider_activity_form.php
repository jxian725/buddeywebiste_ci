...
<div class="row">
  <form novalidate="" id="updateGuiderActivityForm" role="form" method="post" enctype="multipart/form-data">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="form-group" for="rate_per_person">
          <label class="control-label">Price</label>
          <input type="text" name="rate_per_person" id="rate_per_person" value="<?=$rate_per_person;?>" class="form-control" />
        </div>
        <div class="form-group">
  ...
  <div class="col-md-6">
    <div class="form-group" for="maximum_booking">
      <label class="control-label">Maximum Booking</label>
