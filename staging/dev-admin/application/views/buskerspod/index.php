...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("buskerspod/addEvent"), array("class" => "form-horizontal", "autocomplete"=>"off")) ?>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(site_url("buskerspod/updateEvent"), array("class" => "form-horizontal", "autocomplete"=>"off")) ?>
            <div class="form-group">
                <label for="partner_id" class="col-sm-4 control-label">Partner <span class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <select class="form-control select2" style="width: 100%;" data-placeholder="Select Partner" name="partner_id" id="partner_id">
    ...
    $('#calendar').fullCalendar({
        ...
        eventSources: [
           ...
           events: function(start, end, timezone, callback) {
                $.ajax({
                    url: '<?php echo base_url() ?>buskerspod/get_events',
                    dataType: 'json',
                    data: {
        ...
        eventClick: function(event, jsEvent, view) { console.log(event);
            ...
            $.ajax({
                type: "POST",
                url: adminurl + 'buskerspod/currentDateEvent',
