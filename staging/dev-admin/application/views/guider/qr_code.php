...
<div class="portlet-body form add_reward_form">
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                <div class="popup_qrImg"><img style="width: 50%;" src="<?= $dirUrl; ?>uploads/qrscan/<?=$guiderInfo->qr_image;?>"></div>
            </div>
        </div>
    </div>
    <?php
    $print_area = 'printableArea';
    ?>
    <div class="form-actions">
        <a href="javascript:;" class="btn btn-info" onclick="return print_qr_code( '<?=$print_area;?>', '<?=$guider_id;?>' );">Print</a>
  ...
  text-align: center;
    ...
    <div id="print_sec">
        ...
        <main>
          <table>
                <div id="logo">
                    <img src="<?= $dirUrl; ?>uploads/qrscan/<?=$guiderInfo->qr_image;?>">
                    <div style="text-align: center;"><h3>Host: <b><?= $guiderInfo->first_name;?></b></h3></div>
                </div>
          </table>
        </main>
        <footer></footer>
...
//Print QR Code
function print_qr_code( value, guider_id ){
