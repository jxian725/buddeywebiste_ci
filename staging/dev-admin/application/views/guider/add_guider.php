          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control number" maxlength="12" name="phone_number" id="phone_number" placeholder="Mobile number">
                </div>
              </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" name="nric_number" id="nric_number" class="form-control" placeholder="Nric Number" maxlength="30">
                </div>
              </div>
            </div>
            <div class="col-md-6">
