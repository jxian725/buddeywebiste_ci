...
$ipay88->setField('ResponseURL', 'http://localhost/ebuddey-admin/ipay88/response.php');

$ipay88->generateSignature();

$ipay88_fields = $ipay88->getFields();

//echo $ipay88->requery(array('MerchantCode' => 'M10845', 'RefNo' => 'IPAY0000000001', 'Amount' => '1.00'));
