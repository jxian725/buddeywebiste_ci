                    ...
                    <div class="cta_part_text center_div">
                        ...
                        <div class="form_center_div">
                            <form class="form-contact contact_form" role="form" method="post" id="gigsForm" novalidate="">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <!-- <input class="form-control" name="skill_id" id="skill_id" type="text" placeholder="What skill your looking for hire?"> -->
                                ...
                                <div class="row">
                                  <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="other_info" id="other_info" cols="30" rows="9" placeholder="Other information if available"></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="col-md-offset-4 col-md-8 control-label text-left" for="privacy">
                                            ...
                                            I have read, understand and agree to the <a href="#">privacy policy</a>
                                        </label>
                                    </div>
                                </div> 
                                <div class="col-12">
                                    <div class="form-group pull-right">
                                        <div class="g-recaptcha" data-sitekey="6LeGa9cUAAAAAGYbrw-ar3QelE5dC0kRE3nXqe4u"></div>
                                    </div>
                                </div>       
                                <div class="form-group">
