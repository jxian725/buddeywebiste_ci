...
class Buskerspod extends CI_Controller {  
    ...
    public function index() {
		...
		$tplData ['blockedtalents'] = $this->Talentmodel->checkblocktalent($partner_id, $talent_id);
	...
	public function checkblocktalent()
    {
		 $talent_id      = $this->input->get("talent_id");
         $partner_id        = $this->input->get("partner_id");
		 $blockedtalents = $this->Talentmodel->checkblocktalent($partner_id, $talent_id);
		 echo $blockedtalents;
	}
