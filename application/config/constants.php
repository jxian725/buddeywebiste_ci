...
defined('PROCESSING_FEE')   OR define('PROCESSING_FEE', 10);
define('COMPRESS_IMG_SIZE', 20);
define('COMPRESS_IDIMG_SIZE', 30);
define('ADMIN_FOLDER', 'ebuddey-admin');
...
define('COUNTRY_CODE', '+60');
define('COUNTRY_CODE_WC', 'MY+60'); //MY+60

define('RECAPTCHA_SITE_KEY', '6LcajfkUAAAAAN47w65ksKS0xtew128qEALd4z9_');
define('RECAPTCHA_SECRET_KEY', '6LcajfkUAAAAAKrfNxqzuUazMv6qVS1jZPycBHfV');
