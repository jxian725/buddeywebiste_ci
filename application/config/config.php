...
//Upload files path
$config['upload_path_url'] 	    = $config['dir_url'] .'img/';
$config['upload_path']      	= 'img/';
$config['upload_img_path'] 	    = $config['dir_url'] .'img/';
$config['admin_upload_url'] 	= $config['admin_url'] .'uploads/';
$config['admin_upload_path'] 	= 'ebuddey-admin/uploads/';
