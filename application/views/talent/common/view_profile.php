            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="form-group">
                        <img src="<?= $adminUrl;?>uploads/g_profile/<?= $photo; ?>" class="pull-center" style="height: 250px;width: 350px;" align="center"/>
                    </div>
                    <?php } ?>
                    <div class="form-group">
                        <?php $guider_id = (124);?> 
                            ...
                            <li>
                                <a href="https://www.youtube.com/embed/tgbNymZ7vqY"  target="_blank">
                                    <span class="handle ui-sortable-handle">
                                        <iframe width="70" height="35" src="https://www.youtube.com/embed/tgbNymZ7vqY"></iframe>
                                        <p class="text">buddey Youtube vedio</p>
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/embed/tgbNymZ7vqY"  target="_blank">
                                    <span class="handle ui-sortable-handle">
                                        <iframe width="70" height="35" src="https://www.youtube.com/embed/tgbNymZ7vqY"></iframe>
                                        <p class="text">talent buddeytf</p>
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/embed/tgbNymZ7vqY"  target="_blank">
                                    <span class="handle ui-sortable-handle">
                                        <iframe width="70" height="35" src="https://www.youtube.com/embed/tgbNymZ7vqY"></iframe>
                                        <p class="text">buddey Musical event Youtube vedio</p>
                                    </span>
                                </a>
                            </li>
                        </ul>  
