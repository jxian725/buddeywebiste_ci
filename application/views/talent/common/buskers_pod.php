            ...
            <div class="box box-white">
                <div class="box-header with-border">
                    ...
                    <?php
                      ...
                      echo form_open( $dirUrl.'talent/venue/buskers', $attributes );
                      $partner_search = $this->input->get('partner_search');
                      $partner_id     = $this->input->get('partner_id');
                      $partner_id     = $this->input->get( 'filter' );
                      ...
                      <br>
                        ...
                        if($partner_List){
                            foreach ($partner_List as $partner) { ?>
                             <button type="button" class="btn btn-default filterBtn" style="width: 100%;" id="partner_id" value="<?= $partner->partner_id; ?>"><?= rawurldecode($partner->partner_name); ?></button>                     
                        <?php
                            }
                        }else{ ?>
                          <span class="label label-info" style="width: 100%;">Please select city</span>
                        <?php } ?>
                      </br> 
                    </div>
                </div>
...
<!-- daterangepicker -->
<script src="<?= $dirUrl; ?>assets/talent-db/moment.min.js"></script>
<script src="<?= $dirUrl; ?>assets/talent-db/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?= $dirUrl; ?>assets/talent-db/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script type="text/javascript">
$(".filterBtn").click(function(){
  var value = $(this).val();
  if(value=='all'){ 
    window.location.href = baseurl + 'talent/Venue/buskers'; 
  }else{
    window.location.href = baseurl + 'talent/Venue/buskers?filter='+value;
  }
});
...
$(document).ready(function(){
  ...
  <script>
     $(function() {
        ...
        //document.getElementById("datepicker-13").click();
    //var start = $("input[name=start_date]").val();
    //if(start){
      //window.location.href = baseurl + 'talent/venue/buskers?filter=custom&start='+start;
    //}
     });
  </script>                            
