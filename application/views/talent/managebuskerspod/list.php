...
?>
<link href="<?= $adminUrl; ?>assets/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
<link href="<?= $adminUrl; ?>assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
<script src="<?= $adminUrl; ?>assets/global/plugins/datatables/datatables.min.js" type="text/javascript"></script>
<script src="<?= $adminUrl; ?>assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
                ...
                <table id="pod_list" class="table table-striped data-tbl">
                  <thead>
                    <tr class="tbl_head_bg">
                      ...
                      <th class="head1 no-sort">Buskers Pod</th>
...
$(document).ready(function(){
  ...
  $(".applyBtn").click(function(){
    ...
    if(start && end){
      window.location.href = baseurl + 'talent/managebuskerspod?filter=custom&start='+start+'&end='+end;
    }
  });
  $(".filterBtn").click(function(){
    var value = $(this).val();
    if(value=='all'){ 
      window.location.href = baseurl + 'talent/managebuskerspod'; 
    }else{
      window.location.href = baseurl + 'talent/managebuskerspod?filter='+value;
    }
  });
});
$(document).ready(function() {
  table = $('#pod_list').DataTable({
      ...
      "ajax": {
          ...
          "url": "<?php echo site_url('/talent/managebuskerspod/buskerspodTableResponse')?>",
          "type": "POST"
      },
