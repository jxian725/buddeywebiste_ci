                ...
                <table id="pod_list" class="table table-striped data-tbl">
                  <thead>
                    <tr class="tbl_head_bg">
                      ...
                      <th class="head1 no-sort">Venues Action</th>
...
$(document).ready(function(){
  ...
  $(".applyBtn").click(function(){
    ...
    if(start && end){
      window.location.href = baseurl + 'talent/venue/buskerspod?filter=custom&start='+start+'&end='+end;
    }
  });
  $(".filterBtn").click(function(){
    var value = $(this).val();
    if(value=='all'){ 
      window.location.href = baseurl + 'talent/venue/buskerspod'; 
    }else{
      window.location.href = baseurl + 'talent/venue/buskerspod?filter='+value;
    }
  });
});
$(document).ready(function() {
  table = $('#pod_list').DataTable({
      ...
      "ajax": {
          ...
          "url": "<?php echo site_url('/talent/venue/buskerspodTableResponse')?>",
          "type": "POST"
      },
