                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="single-footer-widget footer_2">
                        ...
                        <ul class="list-unstyled">
                            <li><a class="js-scroll-trigger" href="#about">About us</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    ...
                    <div class="copyright_part_text text-center">
                        ...
                        <div class="row d-flex align-items-center">
                          ...
                          <div class="col-md-7 col-lg-8">
                            <!--Copyright-->
                            <p class="footer-text m-0 text-center text-md-left">Copyright &copy;<script>document.write(new Date().getFullYear());</script> Buddey is a trademark of Buddy Technology
                            </p>
                          </div>
                          <!-- Grid column -->
                            ...
                            <div class="text-center text-md-right">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item footer-vertical-l">
                                  <a href="<?php echo $dirUrl; ?>termsandconditions" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                    Terms and Conditions
                                  </a>
                                </li>
                                <li class="list-inline-item">
                                  <a href="<?php echo $dirUrl; ?>privacypolicy" class="btn-floating btn-sm rgba-white-slight mx-1 waves-effect waves-light">
                                    Privacy
                                  </a>
                                </li>
                              </ul>
