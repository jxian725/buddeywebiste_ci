...
class BuskerspodReportmodel extends CI_Model {
    ...
    public $column_order    = array('events.id','partner_list.partner_id','partner_list.address','states.name','start','start','end', 'partnerFees', 'partnerFees', 'transactionID', 'paidDatetime', 'orderID', 'host_id'); 
    public $column_search   = array('events.id','partner_list.partner_id','partner_list.address','states.name','start','start','end', 'partnerFees', 'partnerFees', 'transactionID', 'paidDatetime', 'orderID', 'host_id');
    public $allcolumn_search= array('events.id','partner_list.partner_id','partner_list.address','states.name','start','start','end', 'partnerFees', 'partnerFees', 'transactionID', 'paidDatetime', 'orderID', 'host_id');
    ...
    private function _get_datatables_query(){
        ...
        if($date_from && $date_to){
            ...
            $this->db->where("DATE(start) BETWEEN '".$date_from2."' AND '".$date_to2."'");
        }
