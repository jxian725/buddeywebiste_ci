      ...
      <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div><?=$feedbackInfo->travellerName; ?></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
            ...
            <?php
              if($feedbackInfo->device_type == 1){
                  $device_type    = 'Web';
              }else if($feedbackInfo->device_type == 2){
                  $device_type    = 'iOS';
              }else if($feedbackInfo->device_type == 3){
                  $device_type    = 'Android';
              }else{
                  $device_type    = '';
              }
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div><?= date('d M Y H:i A', strtotime($feedbackInfo->createdon)); ?></div>
            </div>
        </div>
      </div>
    </div>
