                      ...
                      <div class="box-body table-responsive no-padding">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            	<tr>
			                    	<td>
			                    		<input type="checkbox" name="pendingguider[]" id="pendingguider" class="allPLCheck0" <?php if( in_array( 'pendingguider', $permission_arr ) ) { ?> checked <?php } ?> value="pendingguider"> Pending <?= HOST_NAME; ?>
			                    	</td>
			                    	<td>
			                    ...
			                    <tr>
			                    	<td>
			                    		<input type="checkbox" name="guider[]" id="guider" class="allPLCheck" <?php if( in_array( 'guider', $permission_arr ) ) { ?> checked <?php } ?> value="guider"> <?= HOST_NAME; ?>
			                    	</td>
			                    	<td>
			                    ...
			                    <tr>
			                    	<td>
			                    		<input type="checkbox" name="experience[]" id="experience" class="allPLCheck8" <?php if( in_array( 'experience', $permission_arr ) ) { ?> checked <?php } ?> value="experience"> <?= HOST_NAME; ?> Experience
			                    	</td>
			                    	<td>
			                    		<input type="checkbox" <?php if( in_array( 'experience/index', $permission_arr ) ) { ?> checked <?php } ?> name="experience[]" id="experience_index" class="indPLCheck8" value="experience/index"> View
			                    		<input type="checkbox" <?php if( in_array( 'experience/status', $permission_arr ) ) { ?> checked <?php } ?> name="experience[]" id="experience_status" class="indPLCheck8" value="experience/status"> Approve Status 
			                    		<input type="checkbox" <?php if( in_array( 'experience/delete', $permission_arr ) ) { ?> checked <?php } ?> name="experience[]" id="experience_delete" class="indPLCheck8" value="experience/delete"> Delete
			                    	</td>
			                    </tr>
		                	</tbody>
                        </table>
