...
<head>
    ...
    <title>Guest Registration</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                                ...
                                <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; line-height: 140%; color: #8c8888; padding: 10px; text-align: left;" class="center-on-narrow">
                                            ...
                                            <p style="margin: 0 0 10px 0;">
                                                Upload some photos about what you like to do at your profile.
                                            </p>
                                            <!-- Button : BEGIN -->
                                          <!-- Button : END -->
                                        </td>
                        ...
                        <tr>
                            ...
                            <td width="33.33%" class="stack-column-center">
                                <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="padding: 0 10px;">
                                            <img src="<?=$dirUrl;?>img/email/activities.jpg" width="170" height="170" alt="alt_text" border="0" class="center-on-narrow" style="height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="66.66%" class="stack-column-center">
                                <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; line-height: 140%; color: #8c8888; padding: 10px; text-align: left;" class="center-on-narrow">
                                            <h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #696666; font-weight: bold;">Activities</h2>
                                            <p style="margin: 0 0 10px 0;">Review and understand the Buddey Guider activity organised, also message the Guider for more information before booking.</p>
                                            <!-- Button : BEGIN -->
                                          <!-- Button : END -->
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            ...
                            <td width="33.33%" class="stack-column-center">
                                <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="padding: 0 10px;">
                                            <img src="<?=$dirUrl;?>img/email/request.jpg" width="170" height="170" alt="alt_text" border="0" class="center-on-narrow" style="height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="66.66%" class="stack-column-center">
                                <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; line-height: 140%; color: #8c8888; padding: 10px; text-align: left;" class="center-on-narrow">
                                            <h2 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 125%; color: #696666; font-weight: bold;">Requests</h2>
                                            <p style="margin: 0 0 10px 0;">Check Requests for confirmation from Buddey Guider and proceed next to make payment to complete booking.</p>
                                            <!-- Button : BEGIN -->
                                          <!-- Button : END -->
                                        </td>
                                    </tr>
