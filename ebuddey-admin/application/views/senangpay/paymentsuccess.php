...
<head>
  ...
  <title>Buddey | Payment Success</title>
                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body">
                        ...
                        if( $this->session->flashdata( 'paySuccess' ) ) { ?>
                          ...
                          <p class="text-green">Transaction ID : <?php echo $this->session->flashdata( 'paySuccess' ); ?></p>
                        <?php
                        } ?>
                        <center><a href="<?= $this->config->item( 'front_url' ); ?>" class="btn btn-block btn-primary btn-sm">Home</a></center>
                      </div>
                      <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
