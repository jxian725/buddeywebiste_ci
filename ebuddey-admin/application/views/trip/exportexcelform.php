...
<div class="row">
  <form novalidate="" action="<?= $assetUrl; ?>completedtrip/bookings_export" id="exportexcelform" role="form" method="get">
    <div class="col-md-12">
  ...
  <div class="col-md-12">
    ...
    <input type="hidden" name="traveller_id" id="traveller_id" value="<?=$traveller_id;?>">
...
function submitExportExcel() {
  ...
  //window.location.href = "<?php $site_name; ?>/";
  /*$.ajax( {
      type    : "POST",
      data    : data,
      url     : adminurl + 'completedtrip/bookings_export',
      dataType: 'json',
      success: function( msg ) {
          toastr.success( 'Guider Information updated successfully.','Success' );
          setTimeout( function() {
            location.reload();
          }, 500 );
      }
