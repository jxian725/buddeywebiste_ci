...
<div class="portlet-body form add_reward_form">
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                <div class="popup_qrImg"><img style="width: 50%;" src="<?= $dirUrl; ?>uploads/request_qrscan/<?=$requestInfo->qr_image;?>"></div>
            </div>
        </div>
    </div>
    <div class="form-actions">
        <a href="javascript:;" class="btn btn-info" onclick="return print_qr_code( 'printableArea', '<?=$request_id;?>' );">Print</a>
  ...
  text-align: center;
    ...
    <div id="print_sec">
        ...
        <main>
          <table>
                <div id="logo">
                    <img src="<?= $dirUrl; ?>uploads/request_qrscan/<?=$requestInfo->qr_image;?>">
                </div>
          </table>
        </main>
        <footer></footer>
...
//Print QR Code
function print_qr_code( value, request_id ){
