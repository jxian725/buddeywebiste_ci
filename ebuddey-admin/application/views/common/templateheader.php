...
<?php 
  ...
  $userInfo       = $this->Loginmodel->userInfo($user_id);
  $usertype       = '';
?>
<!DOCTYPE html>
<html>
<head>
  ...
  if($page == 'dashboard' || $page == 'index'){ ?>
    <!-- <link rel="stylesheet" type="text/css" href="<?=$this->config->item( 'dir_url' );?>css/bootstrap.min.css"> -->
  <?php } ?>
  ...
  <script src="<?=$this->config->item( 'dir_url' );?>plugins/jquery/dist/emoj.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?=$this->config->item( 'admin_url' );?>" class="logo">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo $assetUrl; ?>logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
