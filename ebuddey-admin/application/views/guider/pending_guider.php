                                ...
                                if($guider_lists) {
                                    foreach ( $guider_lists as $key => $value ) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$status;?></td>
                                            <td>
                                                <?php if( in_array( 'pendingguider/status', $permission_arr ) ) { ?>
                                                    <?=$statusbtn;?>
                                                <?php } ?>
                                                <?php if( in_array( 'pendingguider/index', $permission_arr ) ) { ?>
                                                    <a class="btn btn-primary btn-xs" href="<?=$assetUrl; ?>pendingguider/view/<?=$value->guider_id; ?>" data-toggle="tooltip" data-original-title="View"><i class="fa fa-search"></i></a>
                                                <?php } ?>
                                                <?php if( in_array( 'pendingguider/delete', $permission_arr ) ) { ?>
