                ...
                if($status == 'paid'){
                    ...
                    if($paymentAppType == 'space_booking' || $paymentAppType == 'web_space_booking'){
                        ...
                        $update33   = 'UPDATE events 
                                       SET host_id = "'.$guiderID.'", paidStatus = 1, status = 3, bookedType = "'.$bookedType.'", color = "#9c27b0", transactionID = "'.$transaction_id.'", paidDatetime = "'.$createdon.'"
                    ...
                    if($paymentAppType == 'space_booking' || $paymentAppType == 'web_space_booking'){
                        $update55   = 'UPDATE events 
                                       SET host_id = 0, paidStatus = 0, lockedBy = 0, lockedDateTime = NULL, status = 1
                                       WHERE orderID = "'.$order_id.'"';
