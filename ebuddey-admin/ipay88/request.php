...
$ipay88 = new IPay88('M10845');

//$ipay88->setMerchantKey(/*YOUR_MERCHANT_KEY*/);
$ipay88->setMerchantKey('SbDGYIUkGL');

$ipay88->setField('PaymentId', 2);
$ipay88->setField('RefNo', 'IPAY00000000012');
...
$ipay88->setField('UserEmail', 'sivaraj619@yahoo.com');
$ipay88->setField('UserContact', '0123456789');
$ipay88->setField('Remark', 'Some remarks here..');
$ipay88->setField('Lang', 'utf-8');
$ipay88->setField('ResponseURL', 'http://18.216.41.0/ebuddey-admin/ipay88/response.php');

$ipay88->generateSignature();

$ipay88_fields = $ipay88->getFields();

//echo $ipay88->requery(array('MerchantCode' => 'M10845', 'RefNo' => 'IPAY00000000012', 'Amount' => '1.00'));
