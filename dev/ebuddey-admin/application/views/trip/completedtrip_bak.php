                  ...
                  <table id="completedtrip_list" class="table table-bordered  data-tbl">
                    <thead>
                      <tr class="tbl_head_bg">
                        ...
                        <th class="head1 no-sort">Traveller Name</th>
                        <th class="head1 no-sort">Meeting Date</th>
                        <th class="head1 no-sort">Meeting Time</th>
                        <th class="head1 no-sort">No.of people</th>
                        <th class="head1 no-sort">Guider Name</th>
                        <th class="head1 no-sort">Guider Supporting location</th>
                        <th class="head1 no-sort">Guider Charges (Per Person)(<?= CURRENCYCODE; ?>)</th>
...
function exportExcelForm( guider_id, field ) {
  ...
  $('#myModal .modal-title').html( 'User ID' );
  var trip_id       = $('#trip_id').val();
  var traveller_id  = $('#traveller_id').val();
  var guider_id     = $('#guider_id').val();
  var data = 'trip_id='+trip_id+'&traveller_id='+traveller_id+'&guider_id='+guider_id;
  $.ajax( {
    type: "POST",
    data: data,
