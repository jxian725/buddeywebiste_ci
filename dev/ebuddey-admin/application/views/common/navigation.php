...
$dashactive       = ''; $cityactive    = ''; $feedbackactive = ''; $user_tree = '';
...
$news_tree = ''; $mgmnt_tree = ''; $prod_serv_tree = ''; $trans_pay_tree = '';
if($page == '' || $page == 'client'){
  $dashactive       = 'active';
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?=$prod_serv_tree;?>">
          ...
          <ul class="treeview-menu">
            <li class="<?=$podactive;?>">
              <a href="<?=$this->config->item( 'admin_url' );?>buskerspod">
                <i class="fa fa-music"></i> <span>Buskers Pod Management</span>
                <span class="pull-right-container">
            ...
            <li class="<?=$partneractive;?>">
              <a href="<?=$this->config->item( 'admin_url' );?>partners">
                <i class="fa fa-building-o"></i> <span>Management Partners</span>
                <span class="pull-right-container">
                  <small class="label pull-right bg-green"></small>
                </span>
              </a>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?=$qractive;?>">
              <a href="<?=$this->config->item( 'admin_url' );?>qrscandonate">
                <i class="fa fa-qrcode"></i> <span>QRscan Donate</span>
                <span class="pull-right-container">
                  <small class="label pull-right bg-green"></small>
                </span>
              </a>
        ...
        <li class="treeview <?=$news_tree;?>">
          <a href="#">
            <i class="fa fa-bullhorn"></i> <span>News & Media</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="<?=$journey;?>">
              <a href="<?=$this->config->item( 'admin_url' );?>journeys">
                <i class="fa fa-picture-o"></i> <span>Journeys</span>
                <span class="pull-right-container">
                  <small class="label pull-right bg-green"></small>
                </span>
              </a>
        ...
        <li class="<?=$feedbackactive;?>">
          <a href="<?=$this->config->item( 'admin_url' );?>feedback">
            <i class="fa fa-life-ring"></i> <span>HELP/Feedback</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
