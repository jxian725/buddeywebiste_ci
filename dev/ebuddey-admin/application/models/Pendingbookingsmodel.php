...
class Pendingbookingsmodel extends CI_Model {

	public $primaryKey 		= 'service_id';
    public $column_order 	= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_region_id','guider_charged','service_id','service_id','service_id','service_list.status'); 
    public $column_search 	= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_region_id','guider_charged','service_id','service_id','service_id','service_list.status');
    public $allcolumn_search= array('service_id','service_id','createdon','service_traveller_id','service_date','pickup_time','number_of_person','service_guider_id','service_region_id','guider_charged','service_id','service_id','service_id','service_list.status');
