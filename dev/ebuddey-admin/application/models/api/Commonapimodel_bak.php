...
class Commonapimodel extends CI_Model {
    ...
    function get_specialization_list() {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get Specialization list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No Specialization found.', 'result' => 'error', 'data'=>$data);
            return $result; 
        }
    }
	function get_place_state_list($country_id=false, $states=false) {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get States list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No States found.', 'result' => 'error', 'data' => $data);
            return $result; 
        }
    }
    ...
    function retrieveMessageList( $limit=false, $start=false, $ruser_type=false, $ruser_id=false, $puser_type=false, $puser_id=false,$cuser_type=false ) {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            /*$data11     = array('guider_trash' => 'N');
            $table11    = $this->db->dbprefix( 'messages' );
            $this->db->where_in('msg_id', $msg_ids);
            $this->db->update( $table11, $data11 );*/

            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get Messages list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No Messages found.', 'result' => 'error', 'data' => $data);
            return $result; 
        }
    }
    function deleteMessageList( $ruser_type=false, $ruser_id=false, $puser_type=false, $puser_id=false, $cuser_type=false ) {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Delete Messages list Successfully.', 'result' => 'success', 'data' => array('error' => 1));
            return $result;
        }else {
    ...
    function getGuiderServiceRequest( $limit=false, $start=false, $guider_id=false, $filtertype=false ) {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get Request list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
    ...
    function bankList() {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get Bank list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No Bank found.', 'result' => 'error', 'data' => $data);
            return $result; 
        }
    }
    function updateServiceViews( $user_type, $user_id, $service_ids=false ) {
        ...
        $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Updated Service view status Successfully.', 'result' => 'success', 'data' => array('success' => 1));
        return $result;
    }
    ...
    function get_city_space_list($city_id=false) {
        ...
        if( $query->num_rows() > 0 ) {
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get Spaces list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No Spaces found.', 'result' => 'error', 'data' => $data);
            return $result; 
        }
    }
    //GET AVAILABILITY
        ...
        if( $query->num_rows() > 0 ) {
            ...
            foreach ($spaceLists as $package) {
                ...
                $data[] = array(
                                ...
                                "fees"      => "$package->partnerFees",
                                "host_name" => "$package->first_name",
                                "status"    => $status
                            );
            }
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get packages list Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No packages found.', 'result' => 'error', 'data' => $data);
            return $result; 
        }
    }
    ...
    function get_availability_date_list($partner_id=false) {
        ...
        $this->db->join('guider', 'guider.guider_id = events.host_id','left');
        if($partner_id){ $this->db->where( 'events.partner_id', $partner_id ); }
        $this->db->where( 'events.host_id', 0 );
        $this->db->order_by("start", "desc");
        $query = $this->db->get();
        if( $query->num_rows() > 0 ) {
            $spaceLists   = $query->result();
            ...
            $result = array('response_code' => SUCCESS_CODE, 'response_description' => 'Get availability date Successfully.', 'result' => 'success', 'data' => $data);
            return $result;
        }else {
            $data[] = array('error' => 1);
            $result = array('response_code' => ERROR_CODE, 'response_description' => 'No packages found.', 'result' => 'error', 'data' => $data);
    ...
    public function updateSpaceBookingStatus($data, $id){
