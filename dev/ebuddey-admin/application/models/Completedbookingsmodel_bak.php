...
class Completedbookingsmodel extends CI_Model {
    ...
    public $column_order    = array('journey_id','jny_service_id','journey_list.createdon','jny_traveller_id','service_date','pickup_time','number_of_person','jny_guider_id','service_region_id','guider_charged','journey_id','journey_id','journey_id','jny_status'); 
    public $column_search   = array('journey_id','jny_service_id','journey_list.createdon','jny_traveller_id','service_date','pickup_time','number_of_person','jny_guider_id','service_region_id','guider_charged','journey_id','journey_id','journey_id','jny_status');
    public $allcolumn_search= array('journey_id','jny_service_id','journey_list.createdon','jny_traveller_id','service_date','pickup_time','number_of_person','jny_guider_id','service_region_id','guider_charged','journey_id','journey_id','journey_id','jny_status');
