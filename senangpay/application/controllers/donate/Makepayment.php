...
class Makepayment extends CI_Controller {
	...
	public function form() {
        ...
        if($ishost == 1){
            $data[ 'top_supporters_list' ] = $this->Guidermodel->donation_lists($guiderInfo->guider_id, 10, 1);
            $data[ 'comments_list' ] = $this->Guidermodel->donation_lists($guiderInfo->guider_id, 20);
    ...
    public function submit() {
        ...
        $amount     = ($this->input->post('custom_amount'))? $this->input->post('custom_amount'): $this->input->post('amount');
        ...
        if($request == 'qrpay'){
            ...
            if(!$guiderInfo){
                ...
                //$gift_to  = $this->input->post('gift_to');
                ...
                if($submit == 'submit' && $hostID && $amount){
                    ...
                    $payinfo['detail']         = 'BuddeySenangpay_QRScan_'.$guiderInfo->last_name;
