    ...
    <div class="inner-wrapper">
      <div class="mainform-format">
        ...
        <div class="mainter-form">
          <h4>Space Booking Payment Form</h4>
          <form action="<?php echo $base_url; ?>space/Makepayment/submit" method="post" id="paymentform">
            <div class="myform-group">
              <label>Full Name</label>
              <input type="text" name="fullname" id="fullname" maxlength="40" value="" placeholder="Full Name" />
              <img src="<?php echo $base_url; ?>images/name-icon.png" alt="" />
            </div>
            <div class="myform-group">
              <label>Email</label>
              <input type="email" name="email" id="email" maxlength="60" value="" placeholder="Email" />
              <img src="<?php echo $base_url; ?>images/emial-icon.png" alt="" />
            </div>
            <div class="myform-group">
            <label>Phone Number</label>
            <input type="text" name="phone" id="phone" maxlength="12" value="" class="number" placeholder="Phone Number" />
